          ...
          >
            ...
            >
              <SpotlightCard
                ...
                className="flex h-full flex-col rounded-3xl border border-white/10 bg-white/5 p-8 shadow-[0_25px_60px_-25px_rgba(15,23,42,0.8)] transition duration-500 hover:border-[#8245ec]/60 hover:shadow-[0_32px_65px_-28px_rgba(130,69,236,0.75)]"
              >
